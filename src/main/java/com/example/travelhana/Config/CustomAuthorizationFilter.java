...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
	...
	private List<String> excludeUrlPatterns = new ArrayList<String>(
			Arrays.asList(
					"/swagger-ui.html",
					"/registration",
					"/verification/auth", "/verification", "/updatePassword","/updateDevice","/signin/password",
	...
	protected void doFilterInternal(
		...
		if (servletPath.contains("registration") || servletPath.contains("ws") ||servletPath.contains("dummy")||servletPath.contains("updateDevice")||servletPath.contains("sub")
